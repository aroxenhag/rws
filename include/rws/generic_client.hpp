...
public:
  ...
  : rclcpp::ClientBase(node_base, node_graph)
  {
    ...
    req_ts_hdl_ = rclcpp::get_message_type_support_handle(request_type, rws::ts_identifier, *req_ts_lib_);
    ...
    res_ts_hdl_ = rclcpp::get_message_type_support_handle(response_type, rws::ts_identifier, *res_ts_lib_);
